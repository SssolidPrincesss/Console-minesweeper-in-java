...
В будущем я бы хотел дополнить эту игру графическим интерфейсом в необычном оформлении, возможностью пройти игру на сайте, а также как фишку добавить возможность создавать не только прямоугольные поля (данная форма поля будет даваться игроку на выбор, в отличие от обычного четырехугольного).
